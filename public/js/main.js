document.addEventListener('DOMContentLoaded', () => {
    ...
    endButton.addEventListener('click', () => {
        ...
        let alertMessage = `Limpiador Estándar: ${L1?.nombre || 'No encontrado'}, ` +
                           `Limpiador Premium: ${L2?.nombre || 'No encontrado'}, ` +
                           `Hidratante Estándar: ${H1?.nombre || 'No encontrado'}, ` +
                           `Hidratante Premium: ${H2?.nombre || 'No encontrado'}, ` +
                           `Protector Estándar: ${B1?.nombre || 'No encontrado'}, ` +
                           `Protector Premium: ${B2?.nombre || 'No encontrado'}, ` +
                           `Potenciador Estándar: ${P1?.nombre || 'No encontrado'}, ` +
                           `Potenciador Premium: ${P2?.nombre || 'No encontrado'}`;
